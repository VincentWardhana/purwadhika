            ...
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <center>
                    ...
                    <font style="color: #605E5E">
                        Fill in the information below. You are one step closer<br>to be a professional web Developer.
                    </font>
                    <br><br>
                    <font style="color: #605E5E">
                        If you're a student you can login <a href="login.php">here</a> to get special price.
                    </font>
        ...
        <div class="row" style="">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <form>
                    ...
                    <button type="submit" style="background: rgb(96, 94, 94);color: #FFF;" class="form-control" >Submit</button>
                </form>
            </div>
        </div>
    </div>
