...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Input Bank Data for Transfer <!-- Title Registration --></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <table class="table table-striped table-bordered table-hover table-condensed">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" onchange="" id="bankdata" disabled="true">
                                    ...
                                    <td>
                                        <input type="text" name="" id="bankaccount" class="form-control" disabled="true">
                                    </td>
                                    <td>
                                        <input type="text" name="" id="beneficiaryaccount" class="form-control" disabled="true">
                                    </td>
    ...
    <script type="text/javascript">
        function edit()
        {
            document.getElementById("bankdata").disabled = false;
