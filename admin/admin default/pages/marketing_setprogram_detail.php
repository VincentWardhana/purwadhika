        ...
        <div id="page-wrapper" style="">
            ...
            <div class="row" style="padding:15px 0">
                <div class="col-lg-8" style="">
                    ...
                    <form id="form" method="post" action="marketing_setprogram_detail.php">    
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group custom-search-form">
                                            ...
                                            <input id="registrationfee" name="registrationfee" type="text" class="form-control" onkeypress="return isNumberKey(event);" placeholder="Discount">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group custom-search-form">
                                            ...
                                            <input id="totaldiscount" name="totaldiscount" type="text" class="form-control" onkeypress="return isNumberKey(event);" placeholder="Discount">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
