...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Set Program for Student</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row" style="padding:15px 0">
                ...
                <div class="col-lg-12" style="margin:20px 0">
                    <button type="submit" style="background: #3c763d;color:#FFF;border-radius: 4px;border:none;padding:10px 15px">Set Program</button>
                </div>
            </div>
            <!-- /.row -->
        </div>
