...
<head>
    ...
    <title>Purwadhika - Verification Needed</title>
        ...
        <div class="row" style="">
            <div class="col-lg-12" style="padding:0">
                <div class="col-lg-6 col-lg-offset-3">
                    ...
                    <br><br> -->
                    <center>
                        Your sign up will be successfull in a single step. Please check your email for your next step to verify your account. <br>
